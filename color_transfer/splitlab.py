...
source2 = cv2.cvtColor(source, cv2.COLOR_BGR2LAB)
...
#show_image("Source", sourcel)
#show_image("Target", sourcea)
#show_image("Transfer", sourceb)
cv2.imwrite("sourcel.jpg", L)
cv2.imwrite("sourcea.jpg", A)
cv2.imwrite("sourceb.jpg", B)
cv2.waitKey(0)
