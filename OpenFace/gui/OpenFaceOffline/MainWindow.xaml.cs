            ...
            bool new_image, bool multi_face, float fx, float fy, float cx, float cy, double progress)
        {
            ...
            Dispatcher.Invoke(DispatcherPriority.Render, new TimeSpan(0, 0, 0, 0, 200), (Action)(() =>
            {
                if (ShowAUs)
                {
                    ...
                    var fe_classes = new Dictionary<String, double>();
                    fe_classes["FE01"] = 0.0;
                    fe_classes["FE02"] = 0.0;
                    fe_classes["FE03"] = 0.0;
                    //fe_classes["FE04"] = 0.0;
                    fe_classes["FE05"] = 0.0;
                    fe_classes["FE06"] = 0.0;
                    if (au_classes["AU12"] == 1.0 && au_classes["AU25"] == 1.0)
                    {
                        fe_classes["FE01"] = 1.0;
                    }
                    if (au_classes["AU04"] == 1.0 && au_classes["AU15"] == 1.0)
                    {
                        fe_classes["FE02"] = 1.0;
                    }
                    if (au_classes["AU01"] == 1.0 && au_classes["AU04"] == 1.0 && au_classes["AU20"] == 1.0 && au_classes["AU25"] == 1.0)
                    {
                        fe_classes["FE03"] = 1.0;
                    }
                    if (au_classes["AU01"] == 1.0 && au_classes["AU02"] == 1.0 && au_classes["AU25"] == 1.0 && au_classes["AU26"] == 1.0)
                    {
                        fe_classes["FE05"] = 1.0;
                    }
                    if (au_classes["AU09"] == 1.0 && au_classes["AU10"] == 1.0 && au_classes["AU17"] == 1.0)
                    {
                        fe_classes["FE06"] = 1.0;
                    }

                    feClassGraph.Update(fe_classes);
